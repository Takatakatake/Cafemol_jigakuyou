...
! nlocal
        ...
        do icon = 1, ncon
            ...
            if (inmisc%flag_nlocal_unit(iunit, junit, INTERACT%AICG2) .or. &
                inmisc%flag_nlocal_unit(iunit, junit, INTERACT%AICG2_PLUS)) then !nonlocal aicg2plus
...
! counting the atomic contacts
    do icon = 1, ncon
        ...
        junit = icon2unit(2, icon)
        if (inmisc%flag_nlocal_unit(iunit, junit, INTERACT%AICG2) .or. &
            inmisc%flag_nlocal_unit(iunit, junit, INTERACT%AICG2_PLUS)) then
