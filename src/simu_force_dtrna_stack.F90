!simu_force_dtrna_stack
!> @brief Calculate forces related to stacking interaction of RNA particles.
!
!   See simu_energy_dtrna_stack.F90 for detail
!

 subroutine simu_force_dtrna_stack(irep, force_mp)
     ...
     use var_struct, only: xyz_mp_rep, iclass_mp, &
...
!$omp end do nowait
 ...
 end subroutine simu_force_dtrna_stack
