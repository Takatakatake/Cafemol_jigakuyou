...
subroutine simu_force_ele2(irep, force_mp)

    use const_maxsize
    use const_physical
    use const_index
    use var_neighbor_list, only: lele_k, iele2charge_k
    use var_setp, only: inele
    use var_struct, only: xyz_ele_rep, nmp_all, &
...
!$omp end do nowait
    ...
    end subroutine simu_force_ele2
