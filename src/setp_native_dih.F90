...
subroutine setp_native_dih(xyz_mp_init, xyz_dna)
    ...
    use const_physical
    use const_index
    use var_setp, only: inpro, inmisc, indna, inligand
                ...
                do imp = imp_start, lunit2mp(2, iunit)
                    ...
                    if (impmod == impmod_S) then
                        if (imp - 4 >= lmp) then
                            ...
                            imp3 = imp - 1
                            imp4 = imp
                            call nat_dih_dna2(idih, imp1, imp2, imp3, imp4, DIHTYPE%DNA2_PSPS)
                        endif
                        ...
                        imp3 = imp - 2
                        imp4 = imp
                        call nat_dih_dna2(idih, imp1, imp2, imp3, imp4, DIHTYPE%DNA2_SPSP)
...
contains
    ...
    subroutine nat_dih_dna2(idih, imp1, imp2, imp3, imp4, i_type_dih)
