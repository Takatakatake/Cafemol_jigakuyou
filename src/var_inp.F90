...
module var_inp
    ...
    type inunit
        ...
        integer :: para_pdpwm = 31 ! protein-DNA seq-specific
        integer :: para_pdns = 32 ! protein-DNA seq-non-specific
    ...
    integer, save :: ifile_out_muca
    integer, save :: ifile_out_gro
    integer, save :: ifile_out_top
    ...
    ! Output path
    character(CARRAY_MXFILE), save :: path
