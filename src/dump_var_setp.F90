...
!  type(input_dnaparameter), save :: indna
    ...
    write (lunout, *) 'inpdpwm % pro_dna_pwm_sigma,', inpdpwm%pro_dna_pwm_sigma
    write (lunout, *) 'inpdpwm % pro_dna_pwm_phi,', inpdpwm%pro_dna_pwm_phi
    write (lunout, *) 'inpdpwm % pro_dna_pwm_en0,', inpdpwm%pro_dna_pwm_en0

    write (lunout, *) 'inpdns % pro_dna_nonspec_sigma,', inpdns%pro_dna_nonspec_sigma
    write (lunout, *) 'inpdns % pro_dna_nonspec_phi,', inpdns%pro_dna_nonspec_phi
...
!  enddo
    ...
    write (lunout, *) 'inmisc % i_set_const_radii,', inmisc%i_set_const_radii
