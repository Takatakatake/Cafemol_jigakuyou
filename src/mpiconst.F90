...
!$      nthreads = omp_get_max_threads()
        ...
        write (log_msg_buffer, "(A,I0)") "[mpi] global myrank = ", myrank
        call logger%log_info(log_msg_buffer)
        write (log_msg_buffer, "(A,I0)") "[mpi] total nprocs = ", nprocs
        call logger%log_info(log_msg_buffer)
        write (log_msg_buffer, "(A,I0)") "[omp] nthreads = ", nthreads
        call logger%log_info(log_msg_buffer)
        write (log_msg_buffer, "(A,I0)") "ncores = ", ncores
        call logger%log_info(log_msg_buffer)
