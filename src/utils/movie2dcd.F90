...
!! modified 2016/03/25
    character(43) :: dummy_char43
    character(16) :: dummy_char16
...
!!         read (line, '(a4, i12, f10.3)') char5, inumber, tempk
            else if (line(1:6) == 'REMARK') then
                read (line, '(a43, f10.3)') dummy_char43, tempk
            else if (line(1:5) == 'TITLE') then
                read (line, '(a16, i12)') dummy_char16, inumber
            else if (line(1:4) == '>>>>') then
!!===========================================
                ...
                !! revised for bug-fix 2016/03/25
                lunit2mp(nunit) = iat
                !! revised for bug-fix 2016/03/25
