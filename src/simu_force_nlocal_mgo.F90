...
!>        another subroutine, simu_force_mgo
...
! ************************************************************************
subroutine simu_force_nlocal_mgo(irep, force_mp, force_mp_mgo, ene_unit)
...
!!        if(dist2 > cut_off2) cycle
            ...
            error_message = 'Error: invalid value for iswitch in simu_force_nlocal_mgo'
...
end subroutine simu_force_nlocal_mgo
