...
!!========================================================
!!  modified the format of movie-file to make readable for pymol-software
!!  2016/03/24
!!========================================================
!!     write (outfile%movie(grep), '(a4, i12, f10.3)') &
!!          '<<<<', inumber, tempk
        write (outfile%movie(grep), '(a43, f10.3)') &
            'REMARK    GENERATED BY CAFEMOL at tempk=   ', tempk
        write (outfile%movie(grep), '(a16, i12)') &
            'TITLE     step= ', inumber
!!   write (outfile%movie(grep), '(a5, i12)') &
!!         'MODEL', inumber
        write (outfile%movie(grep), '(a5)') &
            'MODEL'
...
!!========================================================
        ...
        write (outfile%movie(grep), '(a4)') '>>>>'
        write (outfile%movie(grep), '(a6)') 'ENDMDL'
