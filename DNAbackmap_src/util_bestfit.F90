...
subroutine util_bestfit(coord1, nat1, coord2, nat2, nat, coord3, &
  ...
  real(8), intent(in) :: coord1(3, nat1), coord2(3, nat2) ! changed to double precision by M. Shimizu
  real(8), intent(out) :: coord3(3, nat2), rmsd		  ! changed to double precision by M. Shimizu
